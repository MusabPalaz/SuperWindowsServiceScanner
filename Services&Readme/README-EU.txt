...
Don't forget to enable remotesigned to run the script properly. "Set-ExecutionPolicy -ExecutionPolicy RemoteSigned -Scope Process"
And to close  "Set-ExecutionPolicy -ExecutionPolicy Restricted -Scope Process"
